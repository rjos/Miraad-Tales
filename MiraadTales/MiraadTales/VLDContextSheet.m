...
- (void) startWithGestureRecognizer: (CGPoint) point inView: (UIView *) view {
...
- (void) gestureRecognizedStateObserver: (UIGestureRecognizer *) gestureRecognizer {
    if(self.openAnimationFinished && gestureRecognizer.state == UIGestureRecognizerStateEnded) {
        CGPoint touchPoint = [gestureRecognizer locationInView: self];
        
        [self updateItemViewsForTouchPoint: touchPoint];
    }
    else if(gestureRecognizer.state == UIGestureRecognizerStateChanged || gestureRecognizer.state == UIGestureRecognizerStateCancelled) {
