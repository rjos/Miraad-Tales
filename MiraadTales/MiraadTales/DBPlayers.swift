...
public class DBPlayers {
    ...
    public static func getPaladin(view: SKView) -> Player {
        ...
        let paladin = Player(race: race, imageNamed: "Hydora-2", viewController: view)
        
        return paladin
    }
    
    //MARK: Get Person Rohan
    public static func getBard(view: SKView) -> Player {
        ...
        let bard = Player(race: race, imageNamed: "Rohan-2", viewController: view)
        
        return bard
    }
    
    //MARK: Get Person Randall
    public static func getMage(view: SKView) -> Player {
        ...
        let mage = Player(race: race, imageNamed: "Ramdall-2", viewController: view)
        
        return mage
    }
    
    //MARK: Get Person Ylla
    public static func getSwordsman(view: SKView) -> Player {
        ...
        let swordsman = Player(race: race, imageNamed: "Ylla-2", viewController: view)
